...
| Rumble (MBC5) | ✅ the motor bit, and the RAM bank bit it steals on cart types `$1C-$1E`. Measured on Pokemon Pinball: 74 motor edges in a minute of play, pulses averaging 48 ms. Driven through the libretro rumble interface on the edge, never per frame |
